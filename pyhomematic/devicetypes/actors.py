...
class IPSwitchPowermeter(IPSwitch, HMSensor, HelperRssiDevice):
    ...
    def __init__(self, device_description, proxy, resolveparamsets=False):
        ...
        if "HmIP-FSM" in self.TYPE or "HmIP-FSM16" in self.TYPE:
            sensorIndex = 5
        elif "HMIP-PSM" in self.TYPE or "HmIP-PSM" in self.TYPE or "HMIP-PSM-2" in self.TYPE or "HmIP-PSM-2" in self.TYPE or "HmIP-USBSM" in self.TYPE or "HmIP-PSM-CH" in self.TYPE:
            sensorIndex = 6
